...
public class TaskApp {
    public static void enterTaskApp() throws IOException, ClassNotFoundException {
...
// ignore close exception
    ...
    private static class Item extends Tree.TodoAbstract {
        public Item(String title) {
            super(title);
        }
    }

    private static class Container extends Tree.TodoAbstract {
        public Container(String title) {
            super(title);
        }
    }
