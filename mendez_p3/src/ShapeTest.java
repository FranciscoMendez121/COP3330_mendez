...
public class ShapeTest {
    ...
    public void testSquareName(){
        //Need Shape class and need to create a shape object
        Shape shape = new Square(10);
        //Need a getter of getName.
        assertEquals("square",shape.getName());
    }

    @Test
    public void testSquareArea(){
        //class Shape2D extends the Square class
        Shape2D shape = new Square(10);
        //All in the getter::: calculate the area and return that.
    ...
    public void testSquareArea2(){
        ...
        //testing with a double. so Polymorph it to ensure that It can now take a double.
